...
export const CAMPOS_JEFEOBRA: DefinicionCampo[] = [
  ...
  { campo: 'cantidad_sellos_con_factores', label: 'Cantidad sellos con factores', color: 'azul' },
  { campo: 'aislacion', label: 'Aislacion', color: 'azul' },
  { campo: 'cantidad_sellos_aislacion', label: 'Cantidad sellos aislacion', color: 'azul' },
  { campo: 'reparacion_tabique', label: 'Reparacion tabique', color: 'azul' },

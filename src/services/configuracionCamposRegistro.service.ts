...
function mapearRegistroAExcel(registro: Record<string, unknown>): Record<string, unknown> {
  ...
  return {
    ...
    itemizadoMandante: itemizadoMandante
      ...
      : getValue(registro, 'itemizadoMandante', 'itemizado_mandante', 'itemizadoMandanteTexto'),
    ...
    recinto: getValue(registro, 'recinto'),
    ...
    accesibilidad: getValue(registro, 'accesibilidad', 'cielo_modular', 'cieloModular'),
    cielo_modular: getValue(registro, 'accesibilidad', 'cielo_modular', 'cieloModular'),
